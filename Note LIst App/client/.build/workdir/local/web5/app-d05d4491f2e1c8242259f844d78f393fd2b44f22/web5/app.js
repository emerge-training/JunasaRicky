...
AppAddNote.prototype.initializeWidget = function() {
	...
	savebtn.setWidgetBackgroundColor((JkGfxColor.instance("#6aeb7f")));
...
AppAddNote.prototype.createWidget = function() {
	...
	this.container.setWidgetColor((JkGfxColor.instance("#f5706c")));
...
AppAPIClient.create = function(context, parentWidget) {
	...
	AppAPIClient.instance.setApiUrl("http://ec2-13-212-103-99.ap-southeast-1.compute.amazonaws.com:30318");
...
AppDeleteNote.prototype.initializeWidget = function() {
	...
	deletebtn.setWidgetBackgroundColor((JkGfxColor.instance("#6aeb7f")));
...
AppNotelist.prototype.createWidget = function() {
	...
	widget.setWidgetFontSize((this.context.getHeightValue("4mm")));
	...
	this.addbtn.setWidgetText("ADD NOTE");
	this.addbtn.setWidgetPadding((this.context.getHeightValue("1000um")));
	this.addbtn.setWidgetBackgroundColor((JkGfxColor.instance("#ffffff")));
	this.addbtn.setWidgetTextColor((JkGfxColor.instance("#fc3730")));
	...
	this.updatebtn.setWidgetText("UPDATE NOTE");
	this.updatebtn.setWidgetPadding((this.context.getHeightValue("1000um")));
	this.updatebtn.setWidgetBackgroundColor((JkGfxColor.instance("#ffffff")));
	this.updatebtn.setWidgetTextColor((JkGfxColor.instance("#fc3730")));
	...
	this.deletebtn.setWidgetText("DELETE NOTE");
	this.deletebtn.setWidgetPadding((this.context.getHeightValue("1000um")));
	this.deletebtn.setWidgetBackgroundColor((JkGfxColor.instance("#ffffff")));
	this.deletebtn.setWidgetTextColor((JkGfxColor.instance("#fc3730")));
	...
	this.grid.setWidgetCellPadding(2);
